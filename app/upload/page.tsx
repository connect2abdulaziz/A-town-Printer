...
export default function UploadPage() {
  const benefits = [
    ...
    },
    {
      icon: Shield,
      title: 'Secure & Safe',
      description: 'Your files are encrypted and kept confidential',
    },
    {
      icon: FileCheck,
      title: 'Multiple Formats',
      description: 'Supports JPG, PNG, PDF, AI, EPS, PSD, ZIP',
    },
  ];
      ...
      <section className="relative py-16 lg:py-36 overflow-hidden bg-primary text-primary-foreground">
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg sm:text-xl text-primary-foreground/90 max-w-2xl mx-auto">
            Send us your design files and we&apos;ll prepare them for printing. Fast, secure, and professional.
          </p>
        </div>
